...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "metal-button text-foreground hover:text-primary font-mono uppercase tracking-wider text-xs active:metal-button-pressed",
        destructive: "metal-button text-destructive hover:text-destructive/80 font-mono uppercase tracking-wider text-xs",
        outline: "border border-border bg-secondary hover:bg-muted text-foreground",
