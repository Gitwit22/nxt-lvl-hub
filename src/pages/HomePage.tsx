  ...
  return (
    <div className="p-6 md:p-10 space-y-14 max-w-6xl mx-auto">
      ...
      <section className="rounded-xl border border-sky-400/25 bg-sky-500/10 p-5 md:p-6">
        ...
        <h2 className="mt-2 font-mono text-base font-semibold text-sky-50">Create your organization workspace and invite your team</h2>
        <p className="mt-2 text-sm leading-relaxed text-sky-100/90">
          From your suite dashboard, you can create an organization, set up your workspace, and add users
